...
impl TryFrom<u8> for SpecialRequest {
    ...
    fn try_from(value: u8) -> Result<Self, Self::Error> {
        match value {
            x if x == SpecialRequest::ConnectionClose as u8 => Ok(SpecialRequest::ConnectionClose),
...
mod tests {
    ...
    fn should_parse_global_osc_section() {
        ...
        assert_eq!(
            p.parse(&[
                0xF0, 0x00, 0x53, 0x43, 0x00, 0x00, 0x01, 0x00, 0x00, 0x03, 0x00, 0x04, 0x46, 0x28,
                0xF7
            ]),
            Ok(OpenDeckRequest::Configuration(
                Wish::Set,
    ...
    fn should_parse_global_mdns_section() {
        ...
        assert_eq!(
            p.parse(&[
                0xF0, 0x00, 0x53, 0x43, 0x00, 0x00, 0x01, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x6F,
                0xF7
            ]),
            Ok(OpenDeckRequest::Configuration(
                Wish::Set,
    ...
    fn should_parse_global_configuration_unlock_section() {
        ...
        assert_eq!(
            p.parse(&[
                0xF0, 0x00, 0x53, 0x43, 0x00, 0x00, 0x01, 0x00, 0x00, 0x05, 0x00, 0x00, 0x24, 0x34,
                0xF7
            ]),
            Ok(OpenDeckRequest::Configuration(
                Wish::Set,
